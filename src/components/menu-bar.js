  ...
  return (
    <div className="menuBarContainer">
      ...
      <ul className="btnRedes">
        <li><a className="fa-brands fa-github" href='https://github.com/m44tos' target='_blank' rel='noopener noreferrer'></a></li>
        <li><a className="fa-brands fa-linkedin" href='https://www.linkedin.com/in/gabriel-m44tos/' target='_blank' rel='noopener noreferrer'></a></li>
        <li><a className="fa-brands fa-instagram" href='https://www.instagram.com/m44tos' target='_blank' rel='noopener noreferrer'></a></li>
      </ul>
    </div>
  );
}
